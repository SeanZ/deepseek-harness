...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:request/injections.data`](#persistence-type-eventrequestinjectionsdata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"request/injections"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `injections` | 必需 | [`event:request/injections.data.injections`](#persistence-type-eventrequestinjectionsdatainjections) |
...
[`packages/core/session/src/types.ts#RequestMessageInjection`](#persistence-type-packagescoresessionsrctypestsrequestmessageinjection) 的数组。
...
来源：[`packages/core/session/src/types.ts:381`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:24`](../packages/core/tools/src/types.ts)
...
|---|---|---|
| `key` | 必需 | `string` |
| `placement` | 必需 | [`event:request/injections.data.injections[0].placement`](#persistence-type-eventrequestinjectionsdatainjections0placement) |
| `role` | 必需 | `"assistant"` |
| `source` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[1]`](#persistence-type-eventagentinboxspliceddatainserted0source1) |
| `text` | 必需 | `string` |
