...
| `event:request/injections` | event | `c4e08977eb72fc08d58f827cc9c5b302ef39632dd32c3bc9ca7b71e907a0ced7` | [`event:request/injections`](#persistence-type-eventrequestinjections) |
...
Sources: [`packages/core/session/src/types.ts:429`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:437`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:459`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:490`](../packages/core/session/src/types.ts)
...
Source: [`packages/core/session/src/types.ts:425`](../packages/core/session/src/types.ts)
...
<a id="persistence-type-before-latest-user"></a>
...
Sources: [`packages/core/session/src/types.ts:264`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:339`](../packages/core/session/src/types.ts)
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:request/injections.data`](#persistence-type-eventrequestinjectionsdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"request/injections"` |

<a id="persistence-type-eventrequestinjectionsdata"></a>

### `event:request/injections.data`

SHA-256: `dfd436c8568e5df89dd871ff605c3c6e12fc7085402e27234e61fbf6fda058fe`

Sources: [`packages/core/session/src/types.ts:402`](../packages/core/session/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `injections` | required | [`event:request/injections.data.injections`](#persistence-type-eventrequestinjectionsdatainjections) |

<a id="persistence-type-eventrequestinjectionsdatainjections"></a>

### `event:request/injections.data.injections`

SHA-256: `2642a719f3aa331641ca37b53bceea06748692ac6febc4641cca85ef6dd049da`

Array of [`packages/core/session/src/types.ts#RequestMessageInjection`](#persistence-type-packagescoresessionsrctypestsrequestmessageinjection).

<a id="persistence-type-eventrequestinjectionsdatainjections0placement"></a>

### `event:request/injections.data.injections[0].placement`

SHA-256: `f3846beb3d62d4ff8a512c23592ffced831a7af0962d62c4be55190afec28906`

One of:

- [`event:request/injections.data.injections[0].placement[1]`](#persistence-type-eventrequestinjectionsdatainjections0placement1)
- [`event:request/injections.data.injections[0].placement[0]`](#persistence-type-eventrequestinjectionsdatainjections0placement0)

<a id="persistence-type-eventrequestinjectionsdatainjections0placement0"></a>

### `event:request/injections.data.injections[0].placement[0]`
...
<a id="persistence-type-eventrequestinjectionsdatainjections0placement1"></a>

### `event:request/injections.data.injections[0].placement[1]`
...
Sources: [`packages/core/session/src/types.ts:425`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:305`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:307`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:328`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:381`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:24`](../packages/core/tools/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:303`](../packages/core/session/src/types.ts)
...
### `packages/core/session/src/types.ts#RequestMessageInjection`
...
|---|---|---|
| `key` | required | `string` |
| `placement` | required | [`event:request/injections.data.injections[0].placement`](#persistence-type-eventrequestinjectionsdatainjections0placement) |
| `role` | required | `"assistant"` |
| `source` | required | [`event:agent/inbox/spliced.data.inserted[0].source[1]`](#persistence-type-eventagentinboxspliceddatainserted0source1) |
| `text` | required | `string` |
...
Sources: [`packages/core/session/src/types.ts:459`](../packages/core/session/src/types.ts)
...
<a id="persistence-type-requestinjections"></a>
...
Sources: [`packages/core/session/src/types.ts:461`](../packages/core/session/src/types.ts)
